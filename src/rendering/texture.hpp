...
private:
	GLuint texture_id_;
	Texture::StorageType storage_type_;
	GLenum gl_storage_type_;
	Texture::ChannelType channel_type_;
...
public:
	Texture2D(glm::ivec2 dimensions, Texture::StorageType storage_type = Texture::StorageType::FLOAT, 
		Texture::ChannelType channel_type = Texture::ChannelType::RGBA, const void* initial_data);
